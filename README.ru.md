...
- [Неудачи копятся](#неудачи-копятся)
- [Установка](#установка)
  - [NixOS](#nixos)
  - [Любой другой дистрибутив](#любой-другой-дистрибутив)
- [Шрифты](#шрифты)
- [Настройка](#настройка)
- [Оконный тест без выхода из сессии](#оконный-тест-без-выхода-из-сессии)
- [Что где](#что-где)
...
| `corruptOutline` | `#40222222` | тень под искажённым текстом — `textDark` на 25%, единственный ключ, который Qt читает как `#AARRGGBB` |
